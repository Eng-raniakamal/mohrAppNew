...
class permissionRequestView extends StatefulWidget implements NavigationStates
{
  const permissionRequestView ({Key? key}) : super(key: key);
  @override
  State<permissionRequestView > createState() => _permissionRequestViewState();
}

class _permissionRequestViewState extends State<permissionRequestView>with TickerProviderStateMixin {
  ...
  //                       //        onPressed: () => setState(
  //                       //                () => _selectedpermissionType = snapshot.data![index]),
  //                       //        style: identical(
  //                       //            _selectedpermissionType, snapshot.data![index])
  //                       //            ? ButtonStyle(
  ...
  // Future<List<String>?> getpermissionType() async {
  //   // List<permissionType> a;
  ...
  //       return permissionType.fromJson(data as Map<String, dynamic>);
  //     }).toList();
  //
  //
  //     for (var item in a) {
  ...
  //
  //
  //   //List<String> b = List<permissionType>.from(a['name'].toList());
  //
  //   //setState(() {
  //   permissionType = b;
  //   //});
  ...
  // {
  //   List<ValidationpermissionModel> validationpermission = [];
  //   bool? flag = false;
  //   userId = await _appPreferences.getUserToken();
  ...
  //       Uri.parse('${Constants
  //           .validatepermission}$permissionTypeId&fromDate=$startDate&toDate=$endDate&id=$id&duration=$duration'),
  ...
  //   }
  //
  //   //   validationpermission.clear();
  //   //   for (var i in responseData.values) {
  //   //     validationpermission.add(ValidationpermissionModel.fromJson(i));
  //   //   }
  //   //   return validationpermission[0].isValid ;
  //   // } else {
  //   return flag;
  //   // }
  //
...
// });
//
// factory Savepermission.fromJson(Map<String, dynamic> json) {
