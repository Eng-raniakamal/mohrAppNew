    ...
    return ThemeSwitchingArea(
        child: Builder(
            builder: (context) => Scaffold(
                appBar: buildAppBar(context, AppStrings.Vacation.tr()),
                                    ...
                                    SizedBox(
                                        ...
                                        child: FloatingActionButton(
                                          backgroundColor: colorManager
                                              .primary, //child widget inside this button
                                          ...
                                          child: Text(
                                            AppStrings.Vacation_Request.tr(),
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                      ...
                      columns: [
                        DataColumn(
                            label: Text(
                          AppStrings.Vacation_Type.tr(),
                          style: TextStyle(color: colorManager.white),
                        )),
                        DataColumn(
                            label: Text(AppStrings.Current.tr(),
                                style: TextStyle(color: colorManager.white))),
                        DataColumn(
                            label: Text(AppStrings.Transferred.tr(),
                                style: TextStyle(color: colorManager.white))),
                        DataColumn(
                            label: Text(AppStrings.Total.tr(),
                                style: TextStyle(color: colorManager.white))),
                        DataColumn(
                            label: Text(AppStrings.Consumed.tr(),
                                style: TextStyle(color: colorManager.white))),
                        DataColumn(
                            label: Text(AppStrings.Available.tr(),
                                style: TextStyle(color: colorManager.white))),
                        DataColumn(
                            label: Text(AppStrings.Pending.tr(),
                                style: TextStyle(color: colorManager.white))),
                      ],
                      rows: vacations
                          .map((vacation) => DataRow(cells: [
                                DataCell(Text(vacation.vacationTypeName)),
                                DataCell(Text((vacation.vacationTypeDuration)
                                    .toString())),
                                DataCell(
                                    Text((vacation.transferred).toString())),
...
class NumbersWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          buildButton(context, AppStrings.Available.tr(),
              availableDays.toString() + AppStrings.days.tr()),
          buildDivider(),
          buildButton(context, AppStrings.All.tr(),
              allDays.toString() + AppStrings.days.tr()),
          buildDivider(),
          buildButton(context, AppStrings.Used.tr(),
              usedDays.toString() + AppStrings.days.tr()),
        ],
      );
