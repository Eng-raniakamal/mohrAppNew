...
class _MissionRequestViewState extends State<MissionRequestView>with TickerProviderStateMixin {
  ...
  //     int MissionTypeId, int id, int duration) async
  // {
  //   List<ValidationMissionModel> validationMission = [];
  //   bool? flag = false;
  //   userId = await _appPreferences.getUserToken();
  //   final response = await http.get(
  //     //{{baseUrl}}/api/Mission/VaildateMission?MissionTypeId=572&fromDate=2023-08-27&toDate=2023-08-28&id=0&duration=2
  //       Uri.parse('${Constants
  //           .validateMission}$MissionTypeId&fromDate=$startDate&toDate=$endDate&id=$id&duration=$duration'),
