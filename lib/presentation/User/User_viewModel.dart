...
class EmployeeViewModel extends BaseViewModel
    implements EmployeeViewModelInputs, EmployeeViewModelOutputs {
  StreamController _UserIdStreamController =
  ...
  getuserData() async {
    ...
    (await _EmployeeUseCase.execute(EmployeeUseCaseInput(userObject.userID)))
        .fold(
            (failure) => {
