...
const String JSON_PATH = "assets/jsonFiles";
const String ICON_PATH = "assets/icons";

class ImageAssets {
  static const String startLogo = "$IMAGE_PATH/Logo.png";
  ...
  static const String salary = "$ICON_PATH/salary.png";
  static const String attendance = "$ICON_PATH/attendance.png";
  static const String requests = "$ICON_PATH/requests.png";
...
class JsonAssets {
  static const String loading = "$JSON_PATH/loading1.json";
