...
class _VacationRequestViewState extends State<VacationRequestView>with TickerProviderStateMixin {
  ...
  { final DateTime today = DateTime.now();
    _startDate = DateFormat('dd-MM-yyyy').format(today.subtract(const Duration(days: 1))).toString();
                                      ...
                                      child: Column(children:[
                                        ...
                                        Row(
                                            children: [
                                              ...
                                              Text(_startDate,style: const TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                                              const SizedBox(width: 40,),
                                              Text('${AppStrings.to.tr()} : '),
                                              Text(_endDate,style: const TextStyle(fontSize: 15,fontWeight: FontWeight.bold))
                                                      ]
                                            ),
                                        Row(
                    ...
                    Expanded(
                        child: InkWell(
                          child: SizedBox(
                            child: Column(
                              children: [
                                const Icon(Icons.camera_alt, size: 60.0,color:Colors.blue,),
                                const SizedBox(height: 12.0),
                                Text(
