...
class _NotificationViewState extends State<NotificationView> {
  ...
  Widget _createMemoTable(List<NotificationModel>? notification) {
    if (notification?.isEmpty == false) {
      ...
      return Container(
        margin: const EdgeInsets.fromLTRB(40, 40, 30, 0),
        child: Text(
  ...
  List<DataColumn> _createColumns() {
    return [
      DataColumn(label: Text(AppStrings.date.tr(), style: const TextStyle(color: colorManager.white))),
      DataColumn(label: Text(AppStrings.title.tr(), style: const TextStyle(color: colorManager.white))),
      DataColumn(label: Text(AppStrings.details.tr(), style: const TextStyle(color: colorManager.white))),
      DataColumn(label: Text(AppStrings.notes.tr(), style: const TextStyle(color: colorManager.white))),
      DataColumn(label: Text(AppStrings.attachments.tr(), style: const TextStyle(color: colorManager.white))),
      DataColumn(label: Text(AppStrings.canceled.tr(), style: const TextStyle(color: colorManager.white))),
      DataColumn(label: Text(AppStrings.cancellation_Reason.tr(), style: const TextStyle(color: colorManager.white))),
      DataColumn(label: Text(AppStrings.seen.tr(), style: const TextStyle(color: colorManager.white))),
    ];
  }
  ...
  //             height: 150,
  //             child: Text(
  //               _textHandling(notificationItem.details).toString(),
  //               softWrap: true,
  //               maxLines: 2,
  //               overflow: TextOverflow.ellipsis,
  //             ),
  ...
  //             height: 150,
  //             child: Text(
  //               _textHandling(notificationItem.notes).toString(),
  //               maxLines: 2,
  //               overflow: TextOverflow.ellipsis,
  //             ),
  //           ),
  //         ),
  //         DataCell(Text(
  //           _textHandling(notificationItem.attachments).toString() != ""
  //               ? AppStrings.attachments.tr()
  //               : AppStrings.noAttachments.tr(),
  //           onTap: () async {
  //             if (_textHandling(notificationItem.attachments).toString() != "") {
  //               dynamic attachmentData = await getAttachment(int.parse(notificationItem.attachments.toString()));
  //               String img = attachmentData[0]["img"].toString();
                ...
                return AdaptiveScrollbar(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(right: 0, bottom: 30),
                        child: _createMemoTable(notifications),
                      ),
                    ),
                  ),
                );
